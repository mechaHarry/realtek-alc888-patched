...
AC_DEFUN([ALSA_TOPLEVEL_INIT], [
	...
	CONFIG_SND_BF6XX_SOC_SPORT=""
	CONFIG_SND_BF5XX_SOC_I2S=""
	CONFIG_SND_BF6XX_SOC_I2S=""
	...
	CONFIG_SND_POWERPC_SOC=""
	CONFIG_FSL_SOC=""
	CONFIG_PPC_MPC52XX=""
	CONFIG_SND_MPC52XX_DMA=""
	CONFIG_SND_SOC_POWERPC_DMA=""
	...
	CONFIG_SND_SOC_TEGRA20_SPDIF=""
	CONFIG_SND_SOC_TEGRA30_AHUB=""
	...
	CONFIG_SND_SOC_UX500=""
	CONFIG_MFD_DB8500_PRCMU=""
	CONFIG_SND_SOC_UX500_PLAT_MSP_I2S=""
...
AC_ARG_WITH(cards,
  ...
  [                          als100, azt1605, azt2316, azt2320, cmi8328, ]
  [                          cmi8330, cs4231, cs4236, es1688, es18xx, sc6000, ]
  ...
  [                          firewire-speakers, isight, scs1x, vxpocket, ]
  [                          pdaudiocf, sun-amd7930, sun-cs4231, sun-dbri, ]
  [                          harmony, soc, atmel-soc, at91-soc-sam9g20-wm8731, ]
  ...
  [                          designware-i2s, powerpc-soc, soc-mpc8610-hpcd, ]
  [                          soc-p1022-ds, soc-p1022-rdk, soc-mpc5200-i2s, ]
  [                          soc-mpc5200-ac97, mpc52xx-soc-pcm030, ]
  [                          mpc52xx-soc-efika, imx-soc, mxc-soc-wm1133-ev1, ]
  [                          soc-mx27vis-aic32x4, soc-phycore-ac97, ]
  [                          soc-eukrea-tlv320, soc-imx-sgtl5000, ]
  [                          soc-imx-mc13783, jz4740-soc, jz4740-soc-i2s, ]
  [                          jz4740-soc-qi-lb60, soc-nuc900, soc-nuc900evb, ]
  [                          omap-soc, omap-soc-n810, omap-soc-rx51, ]
  [                          omap-soc-ams-delta, omap-soc-osk5912, ]
  [                          omap-soc-am3517evm, omap-soc-omap-twl4030, ]
  [                          omap-soc-omap-abe-twl6040, omap-soc-omap-hdmi, ]
  [                          omap-soc-omap3-pandora, kirkwood-soc, ]
  ...
  [                          pxa910-soc, soc-zylonite, soc-raumfeld, ]
  [                          pxa2xx-soc-hx4700, pxa2xx-soc-magician, ]
  [                          pxa2xx-soc-mioa701, mmp-soc-brownstone, ]
  ...
  [                          soc-speyside, soc-tobermory, soc-bells, ]
  [                          soc-lowland, soc-littlemill, s6000-soc, ]
  [                          s6000-soc-s6ipcam, soc-pcm-sh7760, soc-sh4-fsi, ]
  [                          sh7760-ac97, siu-migor, soc-tegra, ]
  [                          soc-tegra-wm8753, soc-tegra-wm8903, ]
  [                          soc-tegra-wm9712, soc-tegra-trimslice, ]
  [                          soc-tegra-alc5632, soc-txx9aclc, ]
  [                          soc-txx9aclc-generic, soc-ux500, ]
  [                          soc-ux500-plat-dma, soc-ux500-mach-mop500, ]
  [                          simple-card ],
...
AC_ARG_WITH(card_options,
  ...
  [                          hda-codec-hdmi, hda-codec-cirrus, ]
  [                          hda-codec-conexant, hda-codec-ca0110, ]
  [                          hda-codec-ca0132, hda-codec-ca0132-dsp, ]
  ...
  [                          dm365-aic3x-codec, dm365-voice-codec, mmp-soc, ]
  [                          pxa2xx-soc-palm27x, soc-ttc-dkb ]
  [                        Possible integer options are: ]
  [                          max-cards, ac97-power-save-default, ]
  [                          hda-prealloc-size, hda-input-beep-mode, ]
  [                          hda-power-save-default, ps3-default-start-delay, ]
  [                          at73c213-target-bitrate, bfin-ad73311-se, ]
  [                          bf5xx-reset-gpio-num, bf5xx-sport-num ],
  cards="$withval", cards="all")
...
alsa_check_kconfig_int () {
  ...
  int_val=32
  if alsa_check_kconfig_int "max-cards"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_DYNAMIC_MINORS" = "y" -o "$CONFIG_SND_DYNAMIC_MINORS" = "m" ); then
      CONFIG_SND_MAX_CARDS=$int_val
    fi
  fi
  ...
  if alsa_check_kconfig_card "cmi8328"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_ISA" = "y" -o "$CONFIG_SND_ISA" = "m" ); then
      CONFIG_SND_TIMER="m"
      CONFIG_SND_PCM="m"
  ...
  if alsa_check_kconfig_option "hda-reconfig"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ...
      ( test "$CONFIG_SND_HDA_HWDEP" = "y" -o "$CONFIG_SND_HDA_HWDEP" = "m" ); then
  ...
  if alsa_check_kconfig_option "hda-codec-ca0132-dsp"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_PCI" = "y" -o "$CONFIG_SND_PCI" = "m" ) &&
      ( test "$CONFIG_SND_HDA_INTEL" = "y" -o "$CONFIG_SND_HDA_INTEL" = "m" ) &&
      ( ( test "$CONFIG_SND_HDA_CODEC_CA0132" = "y" -o "$CONFIG_SND_HDA_CODEC_CA0132" = "m" ) &&
      ( test "$CONFIG_FW_LOADER" = "y" -o "$CONFIG_FW_LOADER" = "m" ) ); then
  ...
  if alsa_check_kconfig_card "usb-usx2y"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ...
      ( ( test "$CONFIG_X86" = "y" -o "$CONFIG_X86" = "m" ) ||
      ( test "$CONFIG_PPC" = "y" -o "$CONFIG_PPC" = "m" ) ||
      ( test "$CONFIG_ALPHA" = "y" -o "$CONFIG_ALPHA" = "m" ) ) &&
      ( test $kvernum -ge 206024 ); then
      CONFIG_SND_TIMER="m"
      CONFIG_SND_HWDEP="m"
      CONFIG_SND_RAWMIDI="m"
      CONFIG_SND_PCM="m"
  ...
  if alsa_check_kconfig_card "scs1x"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( ( test "$CONFIG_SND_FIREWIRE" = "y" -o "$CONFIG_SND_FIREWIRE" = "m" ) &&
      ( test "$CONFIG_FIREWIRE" = "y" -o "$CONFIG_FIREWIRE" = "m" ) ) &&
      ( test $kvernum -ge 206039 ); then
  ...
  if alsa_check_kconfig_int "ac97-power-save-default"; then
    ...
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ...
      ( test "$CONFIG_RADIO_MAXIRADIO" = "y" -o "$CONFIG_RADIO_MAXIRADIO" = "m" ) ||
      ( test "$CONFIG_RADIO_SHARK" = "y" -o "$CONFIG_RADIO_SHARK" = "m" ) ) &&
      ( ( test "$CONFIG_SND_FM801" = "y" -o "$CONFIG_SND_FM801" = "m" ) ||
      ( test "$CONFIG_SND_ES1968" = "y" -o "$CONFIG_SND_ES1968" = "m" ) ||
      ( test "$CONFIG_RADIO_SF16FMR2" = "y" -o "$CONFIG_RADIO_SF16FMR2" = "m" ) ||
      ( test "$CONFIG_RADIO_MAXIRADIO" = "y" -o "$CONFIG_RADIO_MAXIRADIO" = "m" ) ||
      ( test "$CONFIG_RADIO_SHARK" = "y" -o "$CONFIG_RADIO_SHARK" = "m" ) ); then
  ...
  if alsa_check_kconfig_card "aica"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ...
      ( test "$CONFIG_G2_DMA" = "y" -o "$CONFIG_G2_DMA" = "m" ); then
      CONFIG_SND_TIMER="m"
      CONFIG_SND_PCM="m"
      CONFIG_SND_AICA="m"
    fi
  ...
  if alsa_check_kconfig_card "soc"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ...
      test $kvernum -ge 206014 && CONFIG_AC97_BUS="m"
      test $kvernum -ge 206027 && CONFIG_SND_JACK="y"
      test $kvernum -ge 300000 && CONFIG_SND_COMPRESS_OFFLOAD="m"
      CONFIG_SND_SOC="m"
    fi
  fi
  ...
  if alsa_check_kconfig_int "bf5xx-sport-num"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( ( test "$CONFIG_SND_BF5XX_SOC_SPORT" = "y" -o "$CONFIG_SND_BF5XX_SOC_SPORT" = "m" ) ||
      ( test "$CONFIG_SND_BF6XX_SOC_SPORT" = "y" -o "$CONFIG_SND_BF6XX_SOC_SPORT" = "m" ) ) ); then
  ...
  if alsa_check_kconfig_card "designware-i2s"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_CLKDEV_LOOKUP" = "y" -o "$CONFIG_CLKDEV_LOOKUP" = "m" ); then
      CONFIG_SND_DESIGNWARE_I2S="m"
    fi
  fi
  if alsa_check_kconfig_card "powerpc-soc"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_FSL_SOC" = "y" -o "$CONFIG_FSL_SOC" = "m" ) ||
  ...
  if alsa_check_kconfig_card "soc-mpc8610-hpcd"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_SND_POWERPC_SOC" = "y" -o "$CONFIG_SND_POWERPC_SOC" = "m" ) &&
      ( ( test "$CONFIG_MPC8610_HPCD" = "y" -o "$CONFIG_MPC8610_HPCD" = "m" ) &&
      ( test "$CONFIG_I2C" = "y" -o "$CONFIG_I2C" = "m" ) ); then
      CONFIG_SND_SOC_FSL_SSI="m"
      CONFIG_SND_SOC_FSL_UTILS="m"
      CONFIG_SND_SOC_POWERPC_DMA="m"
  ...
  if alsa_check_kconfig_card "soc-p1022-rdk"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_SND_POWERPC_SOC" = "y" -o "$CONFIG_SND_POWERPC_SOC" = "m" ) &&
      ( ( test "$CONFIG_P1022_RDK" = "y" -o "$CONFIG_P1022_RDK" = "m" ) &&
      ( test "$CONFIG_I2C" = "y" -o "$CONFIG_I2C" = "m" ) ); then
      CONFIG_SND_SOC_FSL_SSI="m"
      CONFIG_SND_SOC_FSL_UTILS="m"
      CONFIG_SND_SOC_POWERPC_DMA="m"
      CONFIG_SND_SOC_WM8960="m"
      CONFIG_SND_SOC_P1022_RDK="m"
    fi
  fi
  ...
  if alsa_check_kconfig_card "imx-soc"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_ARCH_MXC" = "y" -o "$CONFIG_ARCH_MXC" = "m" ); then
  ...
  if alsa_check_kconfig_card "mxc-soc-wm1133-ev1"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ...
      ( test "$CONFIG_MACH_MX31ADS_WM1133_EV1" = "y" -o "$CONFIG_MACH_MX31ADS_WM1133_EV1" = "m" ); then
  ...
  if alsa_check_kconfig_card "soc-imx-sgtl5000"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_SND_IMX_SOC" = "y" -o "$CONFIG_SND_IMX_SOC" = "m" ) &&
      ( ( test "$CONFIG_OF" = "y" -o "$CONFIG_OF" = "m" ) &&
      ( test "$CONFIG_I2C" = "y" -o "$CONFIG_I2C" = "m" ) ); then
      CONFIG_SND_SOC_DMAENGINE_PCM="y"
      CONFIG_SND_SOC_GENERIC_DMAENGINE_PCM="y"
      CONFIG_SND_SOC_IMX_PCM="m"
  ...
  if alsa_check_kconfig_card "soc-imx-mc13783"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_SND_IMX_SOC" = "y" -o "$CONFIG_SND_IMX_SOC" = "m" ) &&
      ( test "$CONFIG_MFD_MC13783" = "y" -o "$CONFIG_MFD_MC13783" = "m" ); then
      CONFIG_SND_SOC_DMAENGINE_PCM="y"
      CONFIG_SND_SOC_GENERIC_DMAENGINE_PCM="y"
      CONFIG_SND_SOC_IMX_PCM="m"
      CONFIG_SND_SOC_IMX_SSI="m"
  ...
  if alsa_check_kconfig_card "omap-soc"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ...
      ( test "$CONFIG_DMA_OMAP" = "y" -o "$CONFIG_DMA_OMAP" = "m" ) ); then
      CONFIG_SND_SOC_DMAENGINE_PCM="y"
  ...
  if alsa_check_kconfig_card "omap-soc-rx51"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_OMAP_SOC" = "y" -o "$CONFIG_SND_OMAP_SOC" = "m" ) &&
      ( test "$CONFIG_MACH_NOKIA_RX51" = "y" -o "$CONFIG_MACH_NOKIA_RX51" = "m" ) ); then
      CONFIG_SND_OMAP_SOC_MCBSP="m"
      CONFIG_SND_SOC_TLV320AIC3X="m"
  ...
  if alsa_check_kconfig_card "omap-soc-omap-twl4030"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_TWL4030_CORE" = "y" -o "$CONFIG_TWL4030_CORE" = "m" ) &&
      ( test "$CONFIG_SND_OMAP_SOC" = "y" -o "$CONFIG_SND_OMAP_SOC" = "m" ) ); then
      CONFIG_SND_OMAP_SOC_MCBSP="m"
      CONFIG_SND_SOC_TWL4030="m"
      CONFIG_SND_OMAP_SOC_OMAP_TWL4030="m"
    fi
  fi
  if alsa_check_kconfig_card "omap-soc-omap-abe-twl6040"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_TWL6040_CORE" = "y" -o "$CONFIG_TWL6040_CORE" = "m" ) &&
      ( test "$CONFIG_SND_OMAP_SOC" = "y" -o "$CONFIG_SND_OMAP_SOC" = "m" ) &&
  ...
  if alsa_check_kconfig_card "omap-soc-omap-hdmi"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_OMAP_SOC" = "y" -o "$CONFIG_SND_OMAP_SOC" = "m" ) &&
      ( test "$CONFIG_OMAP4_DSS_HDMI" = "y" -o "$CONFIG_OMAP4_DSS_HDMI" = "m" ) &&
      ( test "$CONFIG_OMAP2_DSS" = "y" -o "$CONFIG_OMAP2_DSS" = "m" ) ) &&
      ( test "$CONFIG_OMAP4_DSS_HDMI_AUDIO" = "y" -o "$CONFIG_OMAP4_DSS_HDMI_AUDIO" = "m" ); then
  ...
  if alsa_check_kconfig_option "mmp-soc"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_ARCH_MMP" = "y" -o "$CONFIG_ARCH_MMP" = "m" ); then
      CONFIG_SND_SOC_DMAENGINE_PCM="y"
      CONFIG_SND_ARM="y"
  ...
  if alsa_check_kconfig_card "pxa910-soc"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_ARCH_MMP" = "y" -o "$CONFIG_ARCH_MMP" = "m" ); then
      CONFIG_SND_TIMER="m"
  ...
  if alsa_check_kconfig_option "soc-ttc-dkb"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_PXA910_SOC" = "y" -o "$CONFIG_SND_PXA910_SOC" = "m" ) &&
      ( test "$CONFIG_MACH_TTC_DKB" = "y" -o "$CONFIG_MACH_TTC_DKB" = "m" ) ) &&
      ( test "$CONFIG_PXA_SSP" = "y" -o "$CONFIG_PXA_SSP" = "m" ) &&
      ( test "$CONFIG_MFD_88PM860X" = "y" -o "$CONFIG_MFD_88PM860X" = "m" ); then
      CONFIG_SND_SOC_DMAENGINE_PCM="y"
      CONFIG_SND_ARM="y"
      CONFIG_SND_PXA_SOC_SSP="m"
  ...
  if alsa_check_kconfig_card "mmp-soc-brownstone"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_MMP_SOC" = "y" -o "$CONFIG_SND_MMP_SOC" = "m" ) &&
      ( test "$CONFIG_MACH_BROWNSTONE" = "y" -o "$CONFIG_MACH_BROWNSTONE" = "m" ) ) &&
  ...
  if alsa_check_kconfig_card "soc-samsung"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_PLAT_SAMSUNG" = "y" -o "$CONFIG_PLAT_SAMSUNG" = "m" ) &&
  ...
  if alsa_check_kconfig_card "soc-samsung-ln2440sbc-alc650"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_SOC_SAMSUNG" = "y" -o "$CONFIG_SND_SOC_SAMSUNG" = "m" ) &&
      ( test "$CONFIG_ARCH_S3C24XX" = "y" -o "$CONFIG_ARCH_S3C24XX" = "m" ) ) &&
      ( test "$CONFIG_S3C2410_DMA" = "y" -o "$CONFIG_S3C2410_DMA" = "m" ); then
      CONFIG_SND_TIMER="m"
      CONFIG_SND_PCM="m"
      test $kvernum -ge 206014 && CONFIG_AC97_BUS="m"
  ...
  if alsa_check_kconfig_card "soc-samsung-s3c24xx-uda134x"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_SOC_SAMSUNG" = "y" -o "$CONFIG_SND_SOC_SAMSUNG" = "m" ) &&
      ( test "$CONFIG_ARCH_S3C24XX" = "y" -o "$CONFIG_ARCH_S3C24XX" = "m" ) ); then
      CONFIG_SND_S3C24XX_I2S="m"
      CONFIG_SND_SOC_L3="m"
  ...
  if alsa_check_kconfig_card "soc-samsung-smdk-spdif"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_SND_SOC_SAMSUNG" = "y" -o "$CONFIG_SND_SOC_SAMSUNG" = "m" ); then
      CONFIG_SND_SOC_SPDIF="m"
  ...
  if alsa_check_kconfig_card "soc-bells"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_SOC_SAMSUNG" = "y" -o "$CONFIG_SND_SOC_SAMSUNG" = "m" ) &&
      ( test "$CONFIG_MACH_WLF_CRAGG_6410" = "y" -o "$CONFIG_MACH_WLF_CRAGG_6410" = "m" ) ); then
  ...
  if alsa_check_kconfig_card "soc-tegra"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ...
      ( test "$CONFIG_TEGRA20_APB_DMA" = "y" -o "$CONFIG_TEGRA20_APB_DMA" = "m" ) ) &&
      ( test "$CONFIG_REGMAP_MMIO" = "y" -o "$CONFIG_REGMAP_MMIO" = "m" ); then
      CONFIG_SND_SOC_DMAENGINE_PCM="y"
      CONFIG_SND_SOC_GENERIC_DMAENGINE_PCM="y"
    ...
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ...
      ( test "$CONFIG_ARCH_TEGRA_2x_SOC" = "y" -o "$CONFIG_ARCH_TEGRA_2x_SOC" = "m" ) ); then
      CONFIG_SND_SOC_TEGRA20_SPDIF="m"
    fi
  if alsa_check_kconfig_card "soc-tegra-wm8753"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_SOC_TEGRA" = "y" -o "$CONFIG_SND_SOC_TEGRA" = "m" ) &&
      ( test "$CONFIG_I2C" = "y" -o "$CONFIG_I2C" = "m" ) ); then
  ...
  if alsa_check_kconfig_card "soc-tegra-wm9712"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_SOC_TEGRA" = "y" -o "$CONFIG_SND_SOC_TEGRA" = "m" ) &&
      ( test "$CONFIG_ARCH_TEGRA_2x_SOC" = "y" -o "$CONFIG_ARCH_TEGRA_2x_SOC" = "m" ) ); then
  ...
  if alsa_check_kconfig_card "soc-tegra-alc5632"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_SND_SOC_TEGRA" = "y" -o "$CONFIG_SND_SOC_TEGRA" = "m" ) &&
      ( test "$CONFIG_I2C" = "y" -o "$CONFIG_I2C" = "m" ) ); then
  ...
  if alsa_check_kconfig_card "soc-ux500"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_MFD_DB8500_PRCMU" = "y" -o "$CONFIG_MFD_DB8500_PRCMU" = "m" ); then
      CONFIG_SND_SOC_UX500="m"
    fi
  fi
  if alsa_check_kconfig_card "soc-ux500-plat-dma"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( test "$CONFIG_SND_SOC_UX500" = "y" -o "$CONFIG_SND_SOC_UX500" = "m" ); then
      CONFIG_SND_SOC_DMAENGINE_PCM="y"
      CONFIG_SND_SOC_GENERIC_DMAENGINE_PCM="y"
      CONFIG_SND_SOC_UX500_PLAT_DMA="m"
    fi
  fi
  if alsa_check_kconfig_card "soc-ux500-mach-mop500"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ) &&
      ( ( test "$CONFIG_AB8500_CORE" = "y" -o "$CONFIG_AB8500_CORE" = "m" ) &&
      ( test "$CONFIG_AB8500_GPADC" = "y" -o "$CONFIG_AB8500_GPADC" = "m" ) &&
      ( test "$CONFIG_SND_SOC_UX500" = "y" -o "$CONFIG_SND_SOC_UX500" = "m" ) ); then
      CONFIG_SND_SOC_DMAENGINE_PCM="y"
      CONFIG_SND_SOC_GENERIC_DMAENGINE_PCM="y"
  ...
  if alsa_check_kconfig_card "simple-card"; then
    if  ! ( test "$CONFIG_UML" = "y" -o "$CONFIG_UML" = "m" ) &&
      ( test "$CONFIG_SND_SOC" = "y" -o "$CONFIG_SND_SOC" = "m" ); then
      CONFIG_SND_SIMPLE_CARD="m"
    fi
...
if test -n "$CONFIG_SND_MAX_CARDS"; then
  AC_DEFINE_UNQUOTED([CONFIG_SND_MAX_CARDS], [$CONFIG_SND_MAX_CARDS])
fi
...
if test -n "$CONFIG_SND_CMI8328"; then
  AC_DEFINE(CONFIG_SND_CMI8328_MODULE)
fi
...
if test -n "$CONFIG_SND_HDA_DSP_LOADER"; then
  AC_DEFINE(CONFIG_SND_HDA_DSP_LOADER)
fi
...
if test -n "$CONFIG_SND_HDA_CODEC_CA0132_DSP"; then
  AC_DEFINE(CONFIG_SND_HDA_CODEC_CA0132_DSP)
fi
...
if test -n "$CONFIG_SND_SCS1X"; then
  AC_DEFINE(CONFIG_SND_SCS1X_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_DMAENGINE_PCM"; then
  AC_DEFINE(CONFIG_SND_SOC_DMAENGINE_PCM)
fi
if test -n "$CONFIG_SND_SOC_GENERIC_DMAENGINE_PCM"; then
  AC_DEFINE(CONFIG_SND_SOC_GENERIC_DMAENGINE_PCM)
fi
if test -n "$CONFIG_SND_ATMEL_SOC"; then
  AC_DEFINE(CONFIG_SND_ATMEL_SOC_MODULE)
fi
if test -n "$CONFIG_SND_ATMEL_SOC_PDC"; then
  AC_DEFINE(CONFIG_SND_ATMEL_SOC_PDC_MODULE)
fi
if test -n "$CONFIG_SND_ATMEL_SOC_DMA"; then
  AC_DEFINE(CONFIG_SND_ATMEL_SOC_DMA_MODULE)
fi
...
if test -n "$CONFIG_SND_BF6XX_SOC_SPORT"; then
  AC_DEFINE(CONFIG_SND_BF6XX_SOC_SPORT_MODULE)
fi
if test -n "$CONFIG_SND_BF5XX_SOC_I2S"; then
  AC_DEFINE(CONFIG_SND_BF5XX_SOC_I2S_MODULE)
fi
if test -n "$CONFIG_SND_BF6XX_SOC_I2S"; then
  AC_DEFINE(CONFIG_SND_BF6XX_SOC_I2S_MODULE)
fi
...
if test -n "$CONFIG_SND_DESIGNWARE_I2S"; then
  AC_DEFINE(CONFIG_SND_DESIGNWARE_I2S_MODULE)
fi
if test -n "$CONFIG_SND_SOC_FSL_SSI"; then
  AC_DEFINE(CONFIG_SND_SOC_FSL_SSI_MODULE)
fi
if test -n "$CONFIG_SND_SOC_FSL_UTILS"; then
  AC_DEFINE(CONFIG_SND_SOC_FSL_UTILS_MODULE)
fi
if test -n "$CONFIG_SND_POWERPC_SOC"; then
  AC_DEFINE(CONFIG_SND_POWERPC_SOC_MODULE)
fi
if test -n "$CONFIG_SND_MPC52XX_DMA"; then
  AC_DEFINE(CONFIG_SND_MPC52XX_DMA_MODULE)
fi
if test -n "$CONFIG_SND_SOC_POWERPC_DMA"; then
  AC_DEFINE(CONFIG_SND_SOC_POWERPC_DMA_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_P1022_RDK"; then
  AC_DEFINE(CONFIG_SND_SOC_P1022_RDK_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_IMX_SSI"; then
  AC_DEFINE(CONFIG_SND_SOC_IMX_SSI_MODULE)
fi
if test -n "$CONFIG_SND_SOC_IMX_PCM"; then
  AC_DEFINE(CONFIG_SND_SOC_IMX_PCM_MODULE)
fi
if test -n "$CONFIG_SND_SOC_IMX_PCM_FIQ"; then
  AC_DEFINE(CONFIG_SND_SOC_IMX_PCM_FIQ)
fi
if test -n "$CONFIG_SND_SOC_IMX_PCM_DMA"; then
  AC_DEFINE(CONFIG_SND_SOC_IMX_PCM_DMA)
fi
if test -n "$CONFIG_SND_SOC_IMX_AUDMUX"; then
  AC_DEFINE(CONFIG_SND_SOC_IMX_AUDMUX_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_IMX_SGTL5000"; then
  AC_DEFINE(CONFIG_SND_SOC_IMX_SGTL5000_MODULE)
fi
if test -n "$CONFIG_SND_SOC_IMX_MC13783"; then
  AC_DEFINE(CONFIG_SND_SOC_IMX_MC13783_MODULE)
fi
...
if test -n "$CONFIG_SND_OMAP_SOC_OMAP_TWL4030"; then
  AC_DEFINE(CONFIG_SND_OMAP_SOC_OMAP_TWL4030_MODULE)
fi
if test -n "$CONFIG_SND_OMAP_SOC_OMAP_ABE_TWL6040"; then
  AC_DEFINE(CONFIG_SND_OMAP_SOC_OMAP_ABE_TWL6040_MODULE)
fi
if test -n "$CONFIG_SND_OMAP_SOC_OMAP_HDMI"; then
  AC_DEFINE(CONFIG_SND_OMAP_SOC_OMAP_HDMI_MODULE)
fi
...
if test -n "$CONFIG_SND_MMP_SOC"; then
  AC_DEFINE(CONFIG_SND_MMP_SOC)
fi
...
if test -n "$CONFIG_SND_MMP_SOC_SSPA"; then
  AC_DEFINE(CONFIG_SND_MMP_SOC_SSPA_MODULE)
fi
...
if test -n "$CONFIG_SND_PXA910_SOC"; then
  AC_DEFINE(CONFIG_SND_PXA910_SOC_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TTC_DKB"; then
  AC_DEFINE(CONFIG_SND_SOC_TTC_DKB)
fi
...
if test -n "$CONFIG_SND_MMP_SOC_BROWNSTONE"; then
  AC_DEFINE(CONFIG_SND_MMP_SOC_BROWNSTONE_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_BELLS"; then
  AC_DEFINE(CONFIG_SND_SOC_BELLS_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_TEGRA20_AC97"; then
  AC_DEFINE(CONFIG_SND_SOC_TEGRA20_AC97_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TEGRA20_DAS"; then
  AC_DEFINE(CONFIG_SND_SOC_TEGRA20_DAS_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TEGRA20_I2S"; then
  AC_DEFINE(CONFIG_SND_SOC_TEGRA20_I2S_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TEGRA20_SPDIF"; then
  AC_DEFINE(CONFIG_SND_SOC_TEGRA20_SPDIF_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TEGRA30_AHUB"; then
  AC_DEFINE(CONFIG_SND_SOC_TEGRA30_AHUB_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TEGRA30_I2S"; then
  AC_DEFINE(CONFIG_SND_SOC_TEGRA30_I2S_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TEGRA_WM8753"; then
  AC_DEFINE(CONFIG_SND_SOC_TEGRA_WM8753_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TEGRA_WM8903"; then
  AC_DEFINE(CONFIG_SND_SOC_TEGRA_WM8903_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TEGRA_WM9712"; then
  AC_DEFINE(CONFIG_SND_SOC_TEGRA_WM9712_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_UX500"; then
  AC_DEFINE(CONFIG_SND_SOC_UX500_MODULE)
fi
if test -n "$CONFIG_SND_SOC_UX500_PLAT_MSP_I2S"; then
  AC_DEFINE(CONFIG_SND_SOC_UX500_PLAT_MSP_I2S_MODULE)
fi
if test -n "$CONFIG_SND_SOC_UX500_PLAT_DMA"; then
  AC_DEFINE(CONFIG_SND_SOC_UX500_PLAT_DMA_MODULE)
fi
if test -n "$CONFIG_SND_SOC_UX500_MACH_MOP500"; then
  AC_DEFINE(CONFIG_SND_SOC_UX500_MACH_MOP500_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_ARIZONA"; then
  AC_DEFINE(CONFIG_SND_SOC_ARIZONA_MODULE)
fi
if test -n "$CONFIG_SND_SOC_WM_HUBS"; then
  AC_DEFINE(CONFIG_SND_SOC_WM_HUBS_MODULE)
fi
if test -n "$CONFIG_SND_SOC_WM_ADSP"; then
  AC_DEFINE(CONFIG_SND_SOC_WM_ADSP_MODULE)
fi
if test -n "$CONFIG_SND_SOC_AB8500_CODEC"; then
  AC_DEFINE(CONFIG_SND_SOC_AB8500_CODEC_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_AK5386"; then
  AC_DEFINE(CONFIG_SND_SOC_AK5386_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_CS42L52"; then
  AC_DEFINE(CONFIG_SND_SOC_CS42L52_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_DA7213"; then
  AC_DEFINE(CONFIG_SND_SOC_DA7213_MODULE)
fi
if test -n "$CONFIG_SND_SOC_DA732X"; then
  AC_DEFINE(CONFIG_SND_SOC_DA732X_MODULE)
fi
if test -n "$CONFIG_SND_SOC_DA9055"; then
  AC_DEFINE(CONFIG_SND_SOC_DA9055_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_ISABELLE"; then
  AC_DEFINE(CONFIG_SND_SOC_ISABELLE_MODULE)
fi
if test -n "$CONFIG_SND_SOC_LM49453"; then
  AC_DEFINE(CONFIG_SND_SOC_LM49453_MODULE)
fi
if test -n "$CONFIG_SND_SOC_MAX98088"; then
  AC_DEFINE(CONFIG_SND_SOC_MAX98088_MODULE)
fi
if test -n "$CONFIG_SND_SOC_MAX98090"; then
  AC_DEFINE(CONFIG_SND_SOC_MAX98090_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_OMAP_HDMI_CODEC"; then
  AC_DEFINE(CONFIG_SND_SOC_OMAP_HDMI_CODEC_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_SI476X"; then
  AC_DEFINE(CONFIG_SND_SOC_SI476X_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_STA529"; then
  AC_DEFINE(CONFIG_SND_SOC_STA529_MODULE)
fi
if test -n "$CONFIG_SND_SOC_STAC9766"; then
  AC_DEFINE(CONFIG_SND_SOC_STAC9766_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TAS5086"; then
  AC_DEFINE(CONFIG_SND_SOC_TAS5086_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_WM0010"; then
  AC_DEFINE(CONFIG_SND_SOC_WM0010_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_WM2200"; then
  AC_DEFINE(CONFIG_SND_SOC_WM2200_MODULE)
fi
if test -n "$CONFIG_SND_SOC_WM5100"; then
  AC_DEFINE(CONFIG_SND_SOC_WM5100_MODULE)
fi
if test -n "$CONFIG_SND_SOC_WM5102"; then
  AC_DEFINE(CONFIG_SND_SOC_WM5102_MODULE)
fi
if test -n "$CONFIG_SND_SOC_WM5110"; then
  AC_DEFINE(CONFIG_SND_SOC_WM5110_MODULE)
fi
...
if test -n "$CONFIG_SND_SOC_MAX9768"; then
  AC_DEFINE(CONFIG_SND_SOC_MAX9768_MODULE)
fi
if test -n "$CONFIG_SND_SOC_MAX9877"; then
  AC_DEFINE(CONFIG_SND_SOC_MAX9877_MODULE)
fi
if test -n "$CONFIG_SND_SOC_MC13783"; then
  AC_DEFINE(CONFIG_SND_SOC_MC13783_MODULE)
fi
if test -n "$CONFIG_SND_SOC_ML26124"; then
  AC_DEFINE(CONFIG_SND_SOC_ML26124_MODULE)
fi
if test -n "$CONFIG_SND_SOC_TPA6130A2"; then
  AC_DEFINE(CONFIG_SND_SOC_TPA6130A2_MODULE)
fi
if test -n "$CONFIG_SND_SIMPLE_CARD"; then
  AC_DEFINE(CONFIG_SND_SIMPLE_CARD_MODULE)
fi
...
AC_SUBST(CONFIG_RADIO_MAXIRADIO)
AC_SUBST(CONFIG_RADIO_SHARK)
...
AC_SUBST(CONFIG_SND_HDA_DSP_LOADER)
...
AC_SUBST(CONFIG_SND_HDA_CODEC_CA0132_DSP)
...
AC_SUBST(CONFIG_SND_SOC_DMAENGINE_PCM)
AC_SUBST(CONFIG_SND_SOC_GENERIC_DMAENGINE_PCM)
AC_SUBST(CONFIG_SND_ATMEL_SOC)
AC_SUBST(CONFIG_SND_ATMEL_SOC_PDC)
AC_SUBST(CONFIG_SND_ATMEL_SOC_DMA)
...
AC_SUBST(CONFIG_SND_BF6XX_SOC_SPORT)
AC_SUBST(CONFIG_SND_BF5XX_SOC_I2S)
AC_SUBST(CONFIG_SND_BF6XX_SOC_I2S)
...
AC_SUBST(CONFIG_SND_DESIGNWARE_I2S)
AC_SUBST(CONFIG_CLKDEV_LOOKUP)
AC_SUBST(CONFIG_SND_SOC_FSL_SSI)
AC_SUBST(CONFIG_SND_SOC_FSL_UTILS)
AC_SUBST(CONFIG_SND_POWERPC_SOC)
AC_SUBST(CONFIG_FSL_SOC)
AC_SUBST(CONFIG_PPC_MPC52XX)
AC_SUBST(CONFIG_SND_MPC52XX_DMA)
AC_SUBST(CONFIG_SND_SOC_POWERPC_DMA)
AC_SUBST(CONFIG_SND_SOC_MPC8610_HPCD)
AC_SUBST(CONFIG_MPC8610_HPCD)
AC_SUBST(CONFIG_SND_SOC_P1022_DS)
AC_SUBST(CONFIG_P1022_DS)
AC_SUBST(CONFIG_SND_SOC_P1022_RDK)
AC_SUBST(CONFIG_P1022_RDK)
...
AC_SUBST(CONFIG_SND_SOC_IMX_SSI)
AC_SUBST(CONFIG_SND_SOC_IMX_PCM)
AC_SUBST(CONFIG_SND_SOC_IMX_PCM_FIQ)
AC_SUBST(CONFIG_FIQ)
AC_SUBST(CONFIG_SND_SOC_IMX_PCM_DMA)
AC_SUBST(CONFIG_SND_SOC_IMX_AUDMUX)
...
AC_SUBST(CONFIG_SND_SOC_IMX_SGTL5000)
AC_SUBST(CONFIG_OF)
AC_SUBST(CONFIG_SND_SOC_IMX_MC13783)
AC_SUBST(CONFIG_MFD_MC13783)
...
AC_SUBST(CONFIG_SND_OMAP_SOC_OMAP_TWL4030)
AC_SUBST(CONFIG_TWL4030_CORE)
AC_SUBST(CONFIG_SND_OMAP_SOC_OMAP_ABE_TWL6040)
AC_SUBST(CONFIG_TWL6040_CORE)
AC_SUBST(CONFIG_ARCH_OMAP4)
AC_SUBST(CONFIG_SND_OMAP_SOC_OMAP_HDMI)
AC_SUBST(CONFIG_OMAP4_DSS_HDMI)
AC_SUBST(CONFIG_OMAP2_DSS)
AC_SUBST(CONFIG_OMAP4_DSS_HDMI_AUDIO)
...
AC_SUBST(CONFIG_SND_MMP_SOC)
AC_SUBST(CONFIG_ARCH_MMP)
...
AC_SUBST(CONFIG_SND_MMP_SOC_SSPA)
...
AC_SUBST(CONFIG_SND_PXA910_SOC)
AC_SUBST(CONFIG_SND_SOC_TTC_DKB)
AC_SUBST(CONFIG_MACH_TTC_DKB)
...
AC_SUBST(CONFIG_SND_MMP_SOC_BROWNSTONE)
AC_SUBST(CONFIG_MACH_BROWNSTONE)
AC_SUBST(CONFIG_MFD_WM8994)
AC_SUBST(CONFIG_SND_SOC_SAMSUNG)
AC_SUBST(CONFIG_PLAT_SAMSUNG)
...
AC_SUBST(CONFIG_TEGRA20_APB_DMA)
AC_SUBST(CONFIG_REGMAP_MMIO)
AC_SUBST(CONFIG_SND_SOC_TEGRA20_AC97)
AC_SUBST(CONFIG_ARCH_TEGRA_2X_SOC)
AC_SUBST(CONFIG_SND_SOC_TEGRA20_DAS)
AC_SUBST(CONFIG_SND_SOC_TEGRA20_I2S)
AC_SUBST(CONFIG_SND_SOC_TEGRA20_SPDIF)
AC_SUBST(CONFIG_SND_SOC_TEGRA30_AHUB)
AC_SUBST(CONFIG_ARCH_TEGRA_3X_SOC)
AC_SUBST(CONFIG_SND_SOC_TEGRA30_I2S)
AC_SUBST(CONFIG_SND_SOC_TEGRA_WM8753)
AC_SUBST(CONFIG_SND_SOC_TEGRA_WM8903)
AC_SUBST(CONFIG_SND_SOC_TEGRA_WM9712)
...
AC_SUBST(CONFIG_SND_SOC_UX500)
AC_SUBST(CONFIG_MFD_DB8500_PRCMU)
AC_SUBST(CONFIG_SND_SOC_UX500_PLAT_MSP_I2S)
AC_SUBST(CONFIG_SND_SOC_UX500_PLAT_DMA)
AC_SUBST(CONFIG_SND_SOC_UX500_MACH_MOP500)
AC_SUBST(CONFIG_AB8500_CORE)
AC_SUBST(CONFIG_AB8500_GPADC)
AC_SUBST(CONFIG_SND_SOC_I2C_AND_SPI)
AC_SUBST(CONFIG_SND_SOC_ALL_CODECS)
AC_SUBST(CONFIG_SND_SOC_88PM860X)
AC_SUBST(CONFIG_SND_SOC_ARIZONA)
AC_SUBST(CONFIG_SND_SOC_WM_HUBS)
AC_SUBST(CONFIG_SND_SOC_WM_ADSP)
AC_SUBST(CONFIG_SND_SOC_AB8500_CODEC)
...
AC_SUBST(CONFIG_SND_SOC_AK5386)
...
AC_SUBST(CONFIG_SND_SOC_CS42L52)
...
AC_SUBST(CONFIG_SND_SOC_DA7213)
AC_SUBST(CONFIG_SND_SOC_DA732X)
AC_SUBST(CONFIG_SND_SOC_DA9055)
AC_SUBST(CONFIG_SND_SOC_DFBMCS320)
AC_SUBST(CONFIG_SND_SOC_DMIC)
AC_SUBST(CONFIG_SND_SOC_ISABELLE)
AC_SUBST(CONFIG_SND_SOC_LM49453)
AC_SUBST(CONFIG_SND_SOC_MAX98088)
AC_SUBST(CONFIG_SND_SOC_MAX98090)
AC_SUBST(CONFIG_SND_SOC_MAX98095)
AC_SUBST(CONFIG_SND_SOC_MAX9850)
AC_SUBST(CONFIG_SND_SOC_OMAP_HDMI_CODEC)
AC_SUBST(CONFIG_SND_SOC_PCM3008)
AC_SUBST(CONFIG_SND_SOC_RT5631)
AC_SUBST(CONFIG_SND_SOC_SGTL5000)
AC_SUBST(CONFIG_SND_SOC_SI476X)
...
AC_SUBST(CONFIG_SND_SOC_STA529)
AC_SUBST(CONFIG_SND_SOC_STAC9766)
AC_SUBST(CONFIG_SND_SOC_TAS5086)
...
AC_SUBST(CONFIG_SND_SOC_WM0010)
AC_SUBST(CONFIG_SND_SOC_WM1250_EV1)
AC_SUBST(CONFIG_SND_SOC_WM2000)
AC_SUBST(CONFIG_SND_SOC_WM2200)
AC_SUBST(CONFIG_SND_SOC_WM5100)
AC_SUBST(CONFIG_SND_SOC_WM5102)
AC_SUBST(CONFIG_SND_SOC_WM5110)
...
AC_SUBST(CONFIG_SND_SOC_MAX9768)
AC_SUBST(CONFIG_SND_SOC_MAX9877)
AC_SUBST(CONFIG_SND_SOC_MC13783)
AC_SUBST(CONFIG_SND_SOC_ML26124)
AC_SUBST(CONFIG_SND_SOC_TPA6130A2)
AC_SUBST(CONFIG_SND_SIMPLE_CARD)
